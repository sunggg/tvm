...
from tvm.autotvm.tuner import XGBTuner, GATuner, RandomTuner, GridSearchTuner, DefaultRunner
...
tuning_option = {
    ...
    "measure_option": autotvm.measure_option(
        ...
        runner=autotvm.LocalRunner(number=5, repeat=3, timeout=4),
    ),
}
...
def tune_tasks(
    ...
    for i, tsk in enumerate(reversed(tasks)):
        ...
        if tuner == "xgb" or tuner == "xgb-rank":
            tuner_obj = XGBTuner(tsk, loss_type="rank", optimizer_name="sa")
        elif tuner == "ga":
